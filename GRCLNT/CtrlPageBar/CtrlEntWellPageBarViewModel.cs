...
namespace GRCLNT
{
    public class CtrlEntWellPageBarViewModel : Screen
    {
        public CtrlEntWellPageBarViewModel(WndMainViewModel _wndMainVM)
        {
        ...
        public List<C_EntWell> curItemsBd { get; set; }
        public List<C_EntWell> allItemsBd { get; set; }
        ...
        public void Init(List<C_EntWell> logs)
        {
            allItemsBd = logs;
